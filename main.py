...
## Use pymysql for Windows compatibility
# app.config['SQLALCHEMY_DATABASE_URL']='mysql+pymysql://username:password@localhost/databas_table_name'
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/psitdbms'
db=SQLAlchemy(app)
